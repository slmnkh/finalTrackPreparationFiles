...
path_to_gps_file = "/home/skhokhar/common/Project/VSLAM-2k/2014_6_18_Rakesh/GPS_061814_114209.txt"
save_path = "/home/skhokhar/workspace/trackManipulation/rsc/text_files/"

for interName in list_of_intersections:
    
    center = readCenterLocation("/home/skhokhar/workspace/trackManipulation/rsc/intersectionCenters.txt", interName)
    ...
    for i,oneblock in enumerate(trackblocks):
        ...
        numpy.savetxt(save_path+interName+"_"+name+"_%.03d.txt" %i, temp, fmt='%3.15f', delimiter=' ') 
